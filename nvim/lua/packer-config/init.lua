return require("packer").startup(function()
    ...
    use("mfussenegger/nvim-jdtls")  -- builtin language server extension
    use("mfussenegger/nvim-dap")  -- debug adapter protocol
	use({ "rcarriga/nvim-dap-ui", requires = { "mfussenegger/nvim-dap" } })  -- default ui for debug adapter protocol
    use('theHamsta/nvim-dap-virtual-text')  -- virtual text in debug adapter (show values of variables)
end)
